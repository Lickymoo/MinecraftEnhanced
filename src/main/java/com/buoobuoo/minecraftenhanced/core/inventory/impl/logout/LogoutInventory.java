...
import com.buoobuoo.minecraftenhanced.core.inventory.impl.profile.ProfileIconChooseInventory;
import com.buoobuoo.minecraftenhanced.core.inventory.impl.profile.ProfileInventory;
import com.buoobuoo.minecraftenhanced.core.inventory.impl.profile.ProfileRenameInventory;
...
public class LogoutInventory extends CustomInventory {
    ...
    public Inventory getInventory() {
        ...
        ItemStack no = new ItemBuilder(Material.PAPER).setCustomModelData(1000).name("&cYes").lore("&r&fClick to log out").create();
        inv.setItem(24, no);
        inv.setItem(26, no);
